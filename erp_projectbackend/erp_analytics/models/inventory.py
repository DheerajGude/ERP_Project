...
class Stock(models.Model):
    ...
    def __str__(self):
        return f"{self.product.name} – {self.quantity_available} {self.arefresh_from_db}"

    def is_below_reorder_level(self):
        return self.quantity_available <= self.from_db
...
class StockMovement(models.Model):
    ...
    def __str__(self):
        return f"{self.check} | {self.product.name} | {self.quantity}"
